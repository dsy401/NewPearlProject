...
from controller.view.product import store_view
from controller.view.hot_deals import hot_deals_views
from controller.view.tile_category import tiles_categories_view
from controller.view.product_description import product_description_view
...
app.register_blueprint(product_description_view)
